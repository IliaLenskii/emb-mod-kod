...
module.exports = (req, res) => {
    ...
    let arrFunc = [
        function(callback){
            ...
            moModels.docs.find(condF, null, null/*{sort: '-createdAt'}*/ ).populate('step.executor').exec((err, docs) => {
    ...
    async.waterfall(arrFunc, (err, result) => {
        ...
        res.status(200);
        res.render('partials/reports/reports-type-1-filter', res.toTemplates);
    });
};