    ...
    if(listid) {
        ...
        ( async function() {
            ...
            if ( !global.transneftAttrSearchForm ) {
                ...
                let areas = await client.GetSearchAreasAsync( null /*, { proxy: 'http://localhost:' + global.KServerApi.VDirInfo.localPort }*/ );
                transneftId = ( areas[ 0 ] || areas ).Areas.item_Area[ 1 ].id.$value;
                formElems = ( areas[ 0 ] || areas ).Areas.item_Area[ 1 ].attrs.item_SearchAttribute;
            ...
            res.render('layouts/attribute-search', res.toTemplates);
        })();
